...
class Categoria extends Model {
  ...
  const Categoria._internal({required this.id, required name, icon, Events, createdAt, updatedAt}): _name = name, _icon = icon, _Events = Events, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Categoria({String? id, required String name, String? icon, List<Event>? Events}) {
  ...
  Categoria copyWith({String? name, String? icon, List<Event>? Events}) {
    return Categoria._internal(
      id: id,
      name: name ?? this.name,
      icon: icon ?? this.icon,
  ...
  Map<String, dynamic> toJson() => {
    'id': id, 'name': _name, 'icon': _icon, 'Events': _Events?.map((Event? e) => e?.toJson()).toList(), 'createdAt': _createdAt?.format(), 'updatedAt': _updatedAt?.format()
  };
  
  Map<String, Object?> toMap() => {
    'id': id, 'name': _name, 'icon': _icon, 'Events': _Events, 'createdAt': _createdAt, 'updatedAt': _updatedAt
  };
  ...
  static var schema = Model.defineSchema(define: (ModelSchemaDefinition modelSchemaDefinition) {
    ...
    modelSchemaDefinition.addField(ModelFieldDefinition.hasMany(
      key: Categoria.EVENTS,
      isRequired: false,
      ofModelName: 'Event',
      associatedKey: Event.CATEGORYID
    ));
